...
exports.sabPaisaCallback = exports.initiateSabPaisaPayment = void 0;
...
const encrypt = (plainText, key, iv) => {
    const cipher = crypto_1.default.createCipheriv("aes-128-cbc", get16ByteBuf(key), get16ByteBuf(iv));
...
const decrypt = (encryptedText, key, iv) => {
    const decipher = crypto_1.default.createDecipheriv("aes-128-cbc", get16ByteBuf(key), get16ByteBuf(iv));
